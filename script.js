...
class GameOfWar {
    ...
    battle(){
        ...
        if (this.player1.length === 0){
            console.log(`Player 2 has won the game! --Cards left: Player 1: ${this.player1.length} & Player 2: ${this.player2.length}`)
        }else if (this.player2.length === 0){
            console.log(`Player 1 has won the game! --Cards left: Player 1: ${this.player1.length} & Player 2: ${this.player2.length}`)
